...
static void clobSearchStringUse(Connection con)
{
  try
  {
    ...
    // Put the new resume in the database but use a different employee number, 000137, so that the 
    ...
    "SELECT resume " + " FROM emp_resume " + " WHERE empno = '000137'");
    ...
    stmt3.executeUpdate("DELETE FROM emp_resume WHERE empno = '000137' ");
    stmt3.close();
  }
  catch (Exception e)
  {
