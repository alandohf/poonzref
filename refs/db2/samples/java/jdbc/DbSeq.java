...
//         sequence object. It also demonstrates how to use 'nextval'
//         and 'prevval' with a sequence object.
//
// SQL STATEMENTS USED:
//         CREATE SEQUENCE
//         ALTER SEQUENCE
...
class DbSeq
{
  ...
  // This function shows how to use a sequence with 'nextval' to insert table
  // data and generate a gap.
  static void nextValSeq(Connection con)
  {
    try
    {
      ...
      System.out.println(
        ...
        "USE THE SQL STATEMENTS:\n" +
        "  INSERT\n" +
        "TO INSERT TABLE DATA USING A SEQUENCE WITH 'NEXTVAL'");
      ...
      // insert table data using 'NEXTVAL'
      System.out.println();
      System.out.println(
        "  INSERT INTO contract_emp\n" +
        "    VALUES(NEXTVAL FOR id_seq, 'shameem')\n");
      Statement stmt1 = con.createStatement();
      stmt1.executeUpdate(
        "INSERT INTO contract_emp VALUES(NEXTVAL FOR id_seq, 'shameem')");
      stmt1.close();
      ...
      System.out.println(
        "  INSERT INTO contract_emp\n" +
        "    VALUES(NEXTVAL FOR id_seq, 'mohammed')\n");
      Statement stmt2 = con.createStatement();
      stmt2.executeUpdate(
        "INSERT INTO contract_emp VALUES(NEXTVAL FOR id_seq, 'mohammed')");
      stmt2.close();
      ...
      System.out.println(
        "  INSERT INTO contract_emp\n" +
        "    VALUES(NEXTVAL FOR id_seq, 'sunny')\n");
      Statement stmt3 = con.createStatement();
      stmt3.executeUpdate(
        "INSERT INTO contract_emp VALUES(NEXTVAL FOR id_seq,'sunny')");
      stmt3.close();
      ...
      // insert table data using 'nextval' after altering the sequence
      System.out.println();
      System.out.println(
        "  INSERT INTO contract_emp\n" +
        "    VALUES(NEXTVAL FOR id_seq, 'saba')\n"+
        "          (NEXTVAL FOR id_seq, 'repeat')");

      Statement stmt4 = con.createStatement();
      stmt4.executeUpdate(
        "INSERT INTO contract_emp VALUES(NEXTVAL FOR " +
        "id_seq,'saba'), (NEXTVAL FOR id_seq, 'repeat')");
      stmt4.close();
  ...
  // This function shows how to use a sequence with 'PREVVAL' to insert the
  // last generated sequence value into a table.
  static void prevValSeq(Connection con)
  {
    try
    {
      ...
      System.out.println(
        ...
        "USE THE SQL STATEMENTS:\n" +
        "  INSERT INTO PREVVAL\n" +
        "TO INSERT DATA INTO A TABLE USING A SEQUENCE WITH 'PREVVAL'");
      ...
      // insert table data using 'prevval'
      System.out.println(
        "  INSERT INTO emp_location\n" +
        "    VALUES(PREVVAL FOR id_seq, 'repeat')");
      Statement stmt1 = con.createStatement();
      stmt1.executeUpdate(
        "INSERT INTO emp_location VALUES(PREVVAL FOR id_seq, 'repeat')");
      stmt1.close();
      ...
      System.out.println(
        "  Note:\n"+
        "    By using SEQUENCE with 'PREVVAL', you can insert\n"+
