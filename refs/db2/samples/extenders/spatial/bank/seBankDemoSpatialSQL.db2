...
----------------------------------------------------------------------------
--
-- Product Name:     DB2 Spatial Extender v8.1
--
...
--     http://www.software.ibm.com/software/data/spatial/
----------------------------------------------------------------------------
--connect to se_bank;
--===============================================================
...
--CREATE TABLE sample_points(id SMALLINT, geometry ST_POINT, wkb BLOB(32k));
...
--===============================================================
--DROP TABLE sample_points;
--CREATE TABLE sample_points(id SMALLINT, geometry ST_POINT, gml CLOB(32K));
...
--===============================================================
--DROP TABLE sample_points;
--CREATE TABLE sample_points(id SMALLINT, geometry ST_POINT, shape BLOB(32K));
...
--CREATE TABLE sample_geometries(id SMALLINT, spatial_type varchar(18), geometry ST_GEOMETRY);
...
--CREATE TABLE sample_geometries1 (id SMALLINT, spatial_type varchar(13), geometry ST_GEOMETRY);
--CREATE TABLE sample_geometries2 (id SMALLINT, spatial_type varchar(13), geometry ST_GEOMETRY);
...
--CREATE TABLE sample_geomcollections (id SMALLINT, geometry ST_GEOMCOLLECTION);
...
--===============================================================
--DROP TABLE sample_geomcollections;
--CREATE TABLE sample_geomcollections (id SMALLINT, geometry ST_GEOMCOLLECTION, wkb BLOB(32k));
...
--===============================================================
--DROP TABLE sample_geometries;
--CREATE TABLE sample_geometries (id SMALLINT, geometry ST_GEOMETRY, wkb BLOB(32K));
...
--===============================================================
DROP TABLE sample_geometries;
CREATE TABLE sample_geometries(id SMALLINT, spatial_type varchar(20), geometry ST_GEOMETRY);
...
--CREATE TABLE sample_mlines (id SMALLINT, geometry ST_MULTILINESTRING);
...
--===============================================================
--DROP TABLE sample_mlines;
--CREATE TABLE sample_mlines (id SMALLINT, geometry ST_MULTILINESTRING, wkb BLOB(32K));
...
--CREATE TABLE sample_mpoints (id SMALLINT, geometry ST_MULTIPOINT);
...
--===============================================================
--DROP TABLE sample_mpoints;
--CREATE TABLE sample_mpoints (id SMALLINT, geometry ST_MULTIPOINT, wkb BLOB(32K));
...
--===============================================================
--DROP TABLE sample_mpolygons;
--CREATE TABLE sample_mpolygons (id SMALLINT, geometry ST_MULTIPOLYGON, wkb BLOB(32K));
...
--CREATE TABLE sample_geometrycol(id SMALLINT, geometry ST_GEOMCOLLECTION);
...
--DROP TABLE sample_lines;
--CREATE TABLE sample_lines(id SMALLINT, line ST_LINESTRING);
...
--===============================================================
--DROP TABLE sample_polygons;
--CREATE TABLE sample_polygons (id SMALLINT, geometry ST_POLYGON, wkb BLOB(32K));
