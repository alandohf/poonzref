...
##########################################################################
# Description: Create two tables namely, 'dept' and 'emp' and insert data 
#              into them
# Input      : None
...
{ 
  ...
  $dbh->do("CREATE TABLE dept(deptno CHAR(3) NOT NULL, 
                              deptname VARCHAR(20), 
                              CONSTRAINT pk_dept PRIMARY KEY(deptno))") 
  ...
  print "\n  INSERT INTO dept VALUES('A00', 'ADMINISTRATION'),\n". 
        "                         ('B00', 'DEVELOPMENT'),\n". 
        "                         ('C00', 'SUPPORT')\n"; 
  $dbh->do("INSERT INTO dept VALUES('A00', 'ADMINISTRATION'),  
                                   ('B00', 'DEVELOPMENT'),  
                                   ('C00', 'SUPPORT') ") 
  ...
  print "\n  CREATE TABLE emp(empno CHAR(4),\n". 
        "                   empname VARCHAR(10),\n". 
        "                   dept_no CHAR(3))\n"; 
  $dbh->do("CREATE TABLE emp(empno CHAR(4), 
                            empname VARCHAR(10), 
                            dept_no CHAR(3))") 
  ...
  print "\n  INSERT INTO emp VALUES('0010', 'Smith', 'A00'),\n". 
        ...
        "                        ('0060', 'Edwards', 'C00'),\n". 
        "                        ('0070', 'Lea', 'C00')\n"; 
  $dbh->do("INSERT INTO emp VALUES('0010', 'Smith', 'A00'),  
                                  ('0020', 'Ngan', 'B00'),  
                                  ('0030', 'Lu', 'B00'),  
                                  ('0040', 'Wheeler', 'B00'),  
                                  ('0050', 'Burke', 'C00'),  
...
##########################################################################
# Description: Display the contents of the tables 'emp' and 'dept' 
# Input      : None
# Output     : Returns 0 on success 
########################################################################## 
...
{ 
  ...
  my $selectStmt = "SELECT * FROM dept"; 
...
##########################################################################
# Description: Drop tables 'emp' and 'dept' 
# Input      : None
# Output     : Returns 0 on success 
##########################################################################     
...
{ 
  print "\n  DROP TABLE dept\n"; 
  $dbh->do("DROP TABLE dept") 
    || print "Drop Table dept: $DBI::errstr";  
     
  print "\n  DROP TABLE emp\n"; 
  $dbh->do("DROP TABLE emp") 
    || print "Drop Table emp: $DBI::errstr";         
...
{ 
  ...
  if (defined $ruleClause)
  {
    ...
    $strStmt = "ALTER TABLE emp ADD CONSTRAINT fk_dept FOREIGN KEY(dept_no)".                    
               "  REFERENCES dept(deptno) ".$ruleClause; 
  }
  else
  {
    print "\n  ALTER TABLE emp ADD CONSTRAINT fk_dept\n". 
...
{ 
  ...
  my $strStmt = "ALTER TABLE emp DROP CONSTRAINT fk_dept "; 
...
{ 
  ...
  $dbh->do("CREATE TABLE emp_sal(lastname VARCHAR(10) NOT NULL, 
                                 firstname VARCHAR(10), 
                                 salary DECIMAL(7, 2))") 
  ...
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("INSERT INTO emp_sal VALUES(NULL, 'PHILIP', 17000.00) "); 
  print "\n**************************************************\n"; 
            
  # drop table  
  print "\n  DROP TABLE emp_sal\n"; 
 
  $dbh->do("DROP TABLE emp_sal") 
...
{ 
  ...
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("INSERT INTO emp_sal VALUES('SMITH', 'PHILIP', 17000.00),  
                                      ('SMITH', 'PHILIP', 21000.00)"); 
  print "\n**************************************************\n"; 
  ...
  $dbh->do("ALTER TABLE emp_sal DROP CONSTRAINT unique_cn") 
    || print "Alter Table: $DBI::errstr"; 
...
{ 
  ...
  $dbh->do("ALTER TABLE emp_sal DROP CONSTRAINT pk_cn") 
    || print "Alter Table: $DBI::errstr"; 
...
{ 
  ...
  $dbh->do("CREATE TABLE emp_sal(lastname VARCHAR(10), 
                                 firstname VARCHAR(10), 
                                 salary DECIMAL(7, 2), 
              CONSTRAINT check_cn CHECK(salary < 25000.00))") 
    || print "Create Table : $DBI::errstr";    
  ...
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("INSERT INTO emp_sal VALUES('SMITH', 'PHILIP', 27000.00)"); 
  print "\n**************************************************\n"; 
   
  # drop constraint  
  print "\n  ALTER TABLE emp_sal DROP CONSTRAINT check_cn\n"; 
 
  $dbh->do("ALTER TABLE emp_sal DROP CONSTRAINT check_cn") 
    || print "Alter Table: $DBI::errstr"; 
...
{ 
  ...
  $dbh->do("CREATE TABLE emp(empno INTEGER NOT NULL PRIMARY KEY, 
                             name VARCHAR(10), 
                             firstname VARCHAR(20), 
                             salary INTEGER CONSTRAINT minsalary 
                                    CHECK (salary >= 25000) 
  ...
  $dbh->do("INSERT INTO emp VALUES(1, 'SMITH', 'PHILIP', 1000)") 
  ...
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("ALTER TABLE emp ALTER CHECK minsalary ENFORCED"); 
  print "\n**************************************************\n"; 
 
  # delete entries from EMP Table  
  print "\n  DELETE FROM emp\n"; 
  $dbh->do("DELETE FROM emp") 
...
{ 
  ...
  $dbh->do("INSERT INTO emp_sal(lastname, firstname)  
              VALUES('SMITH' , 'PHILIP'),  
                    ('PARKER', 'JOHN'),  
                    ('PEREZ' , 'MARIA') ") 
    || print "Insert : $DBI::errstr"; 
  ...
  my $strStmt = "SELECT * FROM emp_sal"; 
...
{ 
  ...
  $dbh->do("INSERT INTO dept VALUES('D00', 'SALES') ") 
    || print "Insert : $DBI::errstr"; 
 
  # insert child table    
  print "\n  INSERT INTO emp VALUES('0080', 'Pearce', 'E03')\n"; 
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("INSERT INTO emp VALUES('0080', 'Pearce', 'E03') "); 
  print "\n**************************************************\n"; 
...
{ 
  ...
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("UPDATE dept SET deptno = 'E01' WHERE deptno = 'A00' "); 
  print "\n**************************************************\n"; 
  ...
  print "\n**************** Expected Error ******************\n\n"; 
  $dbh->do("UPDATE emp SET dept_no = 'G11' WHERE empname = 'Wheeler' "); 
  print "\n**************************************************\n"; 
...
{ 
  ...
  $dbh->do("DELETE FROM dept WHERE deptno = 'C00'") 
    || print "Delete : $DBI::errstr"; 
  ...
  $dbh->do("DELETE FROM emp WHERE empname = 'Wheeler'") 
    || print "Delete : $DBI::errstr"; 
