...
class XmlToTable
{
 ...
 static void displayContent(Connection con)
 {
   try
   {
     String stmt="SELECT cid, info FROM CUSTOMER";
     ...
     stmt= "SELECT poid, porder from purchaseorder";
 ...
 static void PO_shred(Connection con)
 {
   ...
   try 
   {
     ...
     // create PO table 
     stmt1.executeUpdate("CREATE TABLE PO (purchaseorder XML)");
     PreparedStatement pstmt2;
     PreparedStatement pstmt1=con.prepareStatement("insert into PO values(?)");
