...
*****************************************************************************
**
** SOURCE FILE NAME: admincmd_updateconfig.c                                     
**                                                                        
...
**
** OUTPUT FILE: admincmd_updateconfig.out (available in the online 
**                                         documentation)
*****************************************************************************
**
...
int main(int argc, char *argv[])
{
  ...
  printf("\nTHIS SAMPLE SHOWS HOW TO UPDATE AND RESET THE DB CFG\n"); 
  printf("  AND DBM CFG PARAMETERS USING ADMIN_CMD.\n");
  ...
  /* updatting the Database configuration Parameter dbheap to 1500 */
  strcpy(inparam, "UPDATE DATABASE CONFIGURATION USING DBHEAP 1500 ");
  printf("\nCALL ADMIN_CMD('%s')\n", inparam);
  ...
  printf("The DB CFG parameter is updated successfully.\n");
  
  /* updatting the Database Manager Configuration Parameter aslheapsz
     to 1000 */
  strcpy(inparam, "UPDATE DATABASE MANAGER CONFIGURATION USING ");
  strcat(inparam, "ASLHEAPSZ 1000");
  printf("\nCALL ADMIN_CMD('%s')\n", inparam);
  ...
  printf("The DBM CFG parameter is updated successfully.\n");

  /* resetting the DB CFG parameters for SAMPLE */
  ...
  printf("The DB CFG parameters for SAMPLE DB are resetted successfully.\n");

  /* resetting the DBM CFG parameters */
  strcpy(inparam, "RESET DBM CFG");
  printf("\nCALL ADMIN_CMD('%s')\n", inparam);
  ...
  printf("The DBM CFG parameters are resetted successfully\n");
