...
int GetSnapshotNew(db2AddSnapshotRqstData *snapReq)
{
  ...
  rc = db2GetSnapshotSize(db2Version900, &getSnapshotSizeParam, &sqlca);
  ...
  rc = db2GetSnapshot(db2Version900, &getSnapshotParam, &sqlca);
...
int InitElementNames(void)
{
  ...
  elementName[117] = "SQLM_ELM_EVENT_DBMEMUSE";
  elementName[118] = "SQLM_ELM_EVENT_CONNMEMUSE";
  elementName[119] = "SQLM_ELM_EVENT_DETAILED_DLCONN";
...
int TurnOnAllMonitorSwitches(void)
{
  ...
  db2MonitorSwitches(db2Version900, &switchesData, &sqlca);
