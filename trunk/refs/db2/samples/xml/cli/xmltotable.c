...
int displaycontent(SQLHANDLE hdbc)
{
  ...
  stmt = (SQLCHAR *) "SELECT cid, info FROM CUSTOMER";
  ...
  stmt = (SQLCHAR *) "SELECT poid,porder FROM purchaseorder"; 
  printf("\n%s\n",stmt); 
