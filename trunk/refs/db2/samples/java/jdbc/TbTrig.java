...
class TbTrig
{
  ...
  static void TbBeforeInsertTriggerUse(Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  CREATE TRIGGER min_salary\n" +
      ...
      Statement stmt = con.createStatement();
      stmt.execute("CREATE TRIGGER min_salary " +
                   "  NO CASCADE BEFORE INSERT " +
                   "  ON staff " +
                   "  REFERENCING NEW AS newstaff " +
                   "  FOR EACH ROW " +
    ...
    try
    {
      ...
      System.out.println();
      System.out.println("  DROP TRIGGER min_salary");

      Statement stmt2 = con.createStatement();
      stmt2.executeUpdate("DROP TRIGGER min_salary");
      stmt2.close();
  ...
  static void TbBeforeDeleteTriggerUse(Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  CREATE TRIGGER do_not_del_sales\n" +
      ...
      Statement stmt = con.createStatement();
      stmt.execute("CREATE TRIGGER do_not_del_sales " +
                   "  NO CASCADE BEFORE DELETE " +
                   "  ON staff " +
                   "  REFERENCING OLD AS oldstaff " +
                   "  FOR EACH ROW " +
    ...
    try
    {
      ...
      System.out.println();
      System.out.println("  DROP TRIGGER do_not_del_sales");

      Statement stmt2 = con.createStatement();
      stmt2.executeUpdate("DROP TRIGGER do_not_del_sales");
      stmt2.close();
