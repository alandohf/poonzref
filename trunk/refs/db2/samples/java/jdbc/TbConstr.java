...
class TbConstr
{
  ...
  static void FK_TwoTablesCreate(Connection con)
  {
    try
    {
      ...
      stmt2.executeUpdate("CREATE TABLE emp(empno CHAR(4), " +
                          "                 empname VARCHAR(10), " +
                          "                 dept_no CHAR(3))");
      stmt2.close();
  ...
  static void FK_TwoTablesDrop(Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  DROP TABLE dept");
      Statement stmt = con.createStatement();
      stmt.executeUpdate("DROP TABLE dept");
      stmt.close();

      System.out.println();
      System.out.println("  DROP TABLE emp");
      Statement stmt1 = con.createStatement();
      stmt1.executeUpdate("DROP TABLE emp");
      stmt1.close();
  ...
  static void FK_Create(String ruleClause, Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  ALTER TABLE emp\n" +
      ...
      Statement stmt = con.createStatement();
      stmt.executeUpdate("ALTER TABLE emp " +
                         "  ADD CONSTRAINT fk_dept " +
                         "  FOREIGN KEY(dept_no) " +
                         "  REFERENCES dept(deptno) " +
                         ruleClause);
  ...
  static void FK_Drop(Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  ALTER TABLE emp DROP CONSTRAINT fk_dept");

      Statement stmt = con.createStatement();
      stmt.executeUpdate("ALTER TABLE emp DROP CONSTRAINT fk_dept");
      stmt.close();
  ...
  static void demo_NOT_NULL(Connection con)
  {
    ...
    try
    {
      ...
      Statement stmt2 = con.createStatement();
      stmt2.executeUpdate("DROP TABLE emp_sal");
      stmt2.close();
    }
    catch (Exception e)
    {
  ...
  static void demo_UNIQUE(Connection con)
  {
    ...
    try
    {
      ...
      System.out.println("  DROP TABLE emp_sal");
      Statement stmt3 = con.createStatement();
      stmt3.executeUpdate("DROP TABLE emp_sal");
      stmt3.close();
    }
    catch (Exception e)
    {
  ...
  static void demo_PRIMARY_KEY(Connection con)
  {
    ...
    try
    {
      ...
      Statement stmt2 = con.createStatement();
      stmt2.executeUpdate("ALTER TABLE emp_sal DROP CONSTRAINT pk_cn");
      stmt2.close();
    }
    catch (Exception e)
    {
  ...
  static void demo_CHECK_INFO(Connection con)
  {
    ...
    try
    {
      ...
      // create a table called emp with a 'CHECK' constraint
      System.out.println(
    ...
    try
    {
      ...
      stmt.executeUpdate("ALTER TABLE emp ALTER CHECK minsalary ENFORCED");
      con.commit();
    }
    catch (Exception e)
    {
  ...
  static void demo_WITH_DEFAULT(Connection con)
  {
    ...
    try
    {
      String strStmt;
      System.out.println();
      System.out.println("  INSERT INTO emp_sal(lastname, firstname)\n" +
                         "    VALUES('SMITH', 'PHILIP'),\n" +
                         "          ('PARKER', 'JOHN'),\n" +
                         "          ('PEREZ', 'MARIA')");

      Statement stmt1 = con.createStatement();
      stmt1.executeUpdate("INSERT INTO emp_sal(lastname, firstname) " +
                          "  VALUES('SMITH' , 'PHILIP'), " +
                          "        ('PARKER', 'JOHN'), " +
                          "        ('PEREZ' , 'MARIA') ");
      stmt1.close();
    ...
    try
    {
      ...
      Statement stmt2 = con.createStatement();
      ResultSet rs = stmt2.executeQuery("SELECT * FROM emp_sal");
  ...
  static void demo_FK_OnInsertShow(Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  INSERT INTO dept VALUES('D00', 'SALES')");

      Statement stmt = con.createStatement();
      stmt.executeUpdate("INSERT INTO dept VALUES('D00', 'SALES')");
      stmt.close();
    }
    catch (Exception e)
    {
  ...
  static void demo_FK_ON_DELETE_CASCADE(Connection con)
  {
    ...
    {
      System.out.println();
      System.out.println("  DELETE FROM dept WHERE deptno = 'C00'");

      Statement stmt = con.createStatement();
      stmt.executeUpdate("DELETE FROM dept WHERE deptno = 'C00' ");
      stmt.close();
    }
    catch (Exception e)
    {
    ...
    {
      System.out.println();
      System.out.println("  DELETE FROM emp WHERE empname = 'Wheeler'");

      Statement stmt = con.createStatement();
      stmt.executeUpdate("DELETE FROM emp WHERE empname = 'Wheeler' ");
      stmt.close();
    }
    catch (Exception e)
    {
  ...
  static void demo_FK_ON_DELETE_SET_NULL(Connection con)
  {
    ...
    try
    {
      ...
      Statement stmt1 = con.createStatement();
      stmt1.executeUpdate("DELETE FROM emp WHERE empname = 'Wheeler' ");
      stmt1.close();
    }
    catch (Exception e)
    {
