...
/****************************************************************************
  ...
  *  author		   : panzhiwei
  *  date		   : 2012-03-27
  *  function desc : 使用SQLDriverConnect函数来连接db2数据库(非SQLConnect)，使用了ODBC!
	...
	case WM_COMMAND://
		{
			switch(wParam)
			{
				case IDC_BUTTON1:
				{
					...
					//SQLCHAR ConnStrIn[MAXBUFLEN]="driver={IBM DB2 ODBC DRIVER};Database=SAMPLE;hostname=127.0.0.1;port=50000;protocol=TCPIP;uid=poon; pwd=pzw@@Inn";
